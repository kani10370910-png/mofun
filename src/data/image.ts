...
/* ---------- AI 字体：静态生成历史（已改由 ImageEditor SEED_FONT_RUNS 预置真图） ---------- */
...
export const ipPresetPrompts: Partial<Record<IpExtendTab, Record<string, string>>> = {
  ...
  周边: {
    // 各品类为完整可独立送模提示词（约 400 字）：含人物一致 + 产品形态 + 范围约束 + 电商图规范；配参考 IP 图出图
    抱枕:
      "将参考图中的 IP 形象制作成「抱枕」周边产品电商图。" +
      "【人物一致】以参考图为唯一角色依据，严格保持相同脸型、五官、表情、发型与发色、服饰与配色、体型比例与整体画风，不得更换人物，不得改变性别与年龄。" +
      "【产品形态】真实柔软方形白色抱枕，自然摆放在浅色沙发或椅面上，布面有轻微褶皱与棉麻质感，抱枕四角圆润、边缘清晰可见。" +
      "【印制方式】IP 仅为抱枕正面居中的平面印刷图案，不是立体立在抱枕旁，也不是独立角色叠在沙发上。" +
      "【范围约束】整只角色含帽檐、叶片、麦穗、道具、手足必须完整落在抱枕布面轮廓内，四周留安全边距；严禁任何部位画出抱枕边缘、浮在抱枕外或叠到沙发背景。" +
      "【画面】柔和棚拍光，浅景深，纯净浅色背景，单个产品居中，无文字、无水印、无多余 logo，电商主图清晰锐利。",
    马克杯:
      "将参考图中的 IP 形象制作成「马克杯」周边产品电商图。" +
      "【人物一致】以参考图为唯一角色依据，严格保持相同脸型、五官、表情、发型与发色、服饰与配色、体型比例与整体画风，不得更换人物，不得改变性别与年龄。" +
      "【产品形态】真实白色陶瓷马克杯，带杯柄，摆在木质书桌或浅色台面上，杯身光洁，可见轻微高光与材质反光。" +
      "【印制方式】IP 仅为杯身圆柱可视面上的平面印刷图案，环绕或居中贴合杯面，不是立体立在杯旁。" +
      "【范围约束】整只角色含帽檐、叶片、麦穗、道具、手足必须完整落在杯身可视印刷区内，四周留安全边距；严禁画出杯口、杯底或杯柄外轮廓，禁止浮在杯子旁或叠到桌面背景。" +
      "【画面】柔和棚拍光，浅景深，纯净浅色背景，单个产品居中，无文字、无水印、无多余 logo，电商主图清晰锐利。",
    笔记本:
      "将参考图中的 IP 形象制作成「笔记本」周边产品电商图。" +
      "【人物一致】以参考图为唯一角色依据，严格保持相同脸型、五官、表情、发型与发色、服饰与配色、体型比例与整体画风，不得更换人物，不得改变性别与年龄。" +
      "【产品形态】真实精装或软皮笔记本，封面平整，放在展示架或浅色桌面上，可见书脊、封面边缘与轻微厚度。" +
      "【印制方式】IP 仅为笔记本封面正面居中的平面印刷图案，不是立体立在本子旁。" +
      "【范围约束】整只角色含帽檐、叶片、麦穗、道具、手足必须完整落在封面矩形与书脊以内，四周留安全边距；严禁画出封面四边，禁止叠到桌面或背景家具上。" +
      "【画面】柔和棚拍光，浅景深，纯净浅色背景，单个产品居中，无文字、无水印、无多余 logo，电商主图清晰锐利。",
    钥匙扣:
      "将参考图中的 IP 形象制作成「钥匙扣」周边产品电商图。" +
      "【人物一致】以参考图为唯一角色依据，严格保持相同脸型、五官、表情、发型与发色、服饰与配色、体型比例与整体画风，不得更换人物，不得改变性别与年龄。" +
      "【产品形态】真实透明亚克力钥匙扣，配金属钥匙环，牌面圆角方形或圆角造型，边缘与厚度清晰，可轻微反光。" +
      "【印制方式】IP 完整封装在亚克力牌主体内，作为钥匙扣图案/造型主体，金属环在上方，不是角色脱离钥匙扣独立存在。" +
      "【范围约束】整只角色含帽檐、叶片、麦穗、道具、手足必须完整落在亚克力牌外轮廓内，四周留安全边距；严禁任何部位画出亚克力边缘或伸出钥匙扣外。" +
      "【画面】柔和棚拍光，浅景深，纯净浅色背景，单个产品居中，无文字、无水印、无多余 logo，电商主图清晰锐利。",
    手提袋:
      "将参考图中的 IP 形象制作成「手提袋」周边产品电商图。" +
      "【人物一致】以参考图为唯一角色依据，严格保持相同脸型、五官、表情、发型与发色、服饰与配色、体型比例与整体画风，不得更换人物，不得改变性别与年龄。" +
      "【产品形态】真实布艺或帆布手提袋，正面朝向镜头，可见袋身、侧缝与上方提手，布面有轻微纹理与垂感。" +
      "【印制方式】IP 仅为袋身正面居中的平面印刷图案，不是立体立在袋子旁。" +
      "【范围约束】整只角色含帽檐、叶片、麦穗、道具、手足必须完整落在袋身正面布面内，四周留安全边距；严禁画出袋口、侧缝或提手区域，禁止浮在袋子外或叠到背景上。" +
      "【画面】柔和棚拍光，浅景深，纯净浅色背景，单个产品居中，无文字、无水印、无多余 logo，电商主图清晰锐利。",
  },
};
