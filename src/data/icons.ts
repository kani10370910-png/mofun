...
export const ICON_PATHS = {
  ...
  // 发送：纸飞机
  send:
    '<path d="M4.5 11.5 19.5 4.5 12.5 19.5l-2-6.5-6-1.5Z"/><path d="m10.5 13 9-8.5"/>',
  // —— 尺寸形状图标 ——
  ...
  thumbUp:
    '<path d="M7 11v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-8a1 1 0 0 1 1-1h2Zm0 0V8.5A3.5 3.5 0 0 1 10.5 5h.3c.9 0 1.7.5 2.1 1.3L14 9h4.2a2 2 0 0 1 1.9 2.6l-1.4 5A2 2 0 0 1 16.8 18H9a2 2 0 0 1-2-2"/>',
  thumbDown:
    '<path d="M7 13V4a1 1 0 0 0-1-1H4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h2Zm0 0v2.5A3.5 3.5 0 0 0 10.5 19h.3c.9 0 1.7-.5 2.1-1.3L14 15h4.2a2 2 0 0 0 1.9-2.6l-1.4-5A2 2 0 0 0 16.8 6H9a2 2 0 0 0-2 2"/>',
  copy:
  ...
  // 新建对话：气泡 + 中心加号
  chatNew:
    '<path d="M4 6a2.5 2.5 0 0 1 2.5-2.5h11A2.5 2.5 0 0 1 20 6v8a2.5 2.5 0 0 1-2.5 2.5H10l-4 3.2V16.5A2.5 2.5 0 0 1 4 14V6Z"/><path d="M12 8v5"/><path d="M9.5 10.5h5"/>',
  // 对话气泡（历史列表用）
  chatBubble:
    '<path d="M4 6a2.5 2.5 0 0 1 2.5-2.5h11A2.5 2.5 0 0 1 20 6v8a2.5 2.5 0 0 1-2.5 2.5H10l-4 3.2V16.5A2.5 2.5 0 0 1 4 14V6Z"/>',
  // 左侧面板展开/收起（竖线靠左）
  panelLeft:
  ...
  undo: '<path d="M9 7 4 12l5 5"/><path d="M4 12h11a5 5 0 0 1 5 5v0"/>',
  redo: '<path d="m15 7 5 5-5 5"/><path d="M20 12H9a5 5 0 0 0-5 5v0"/>',
  save:
 ...
 pinTop: '<path d="M9 4h6"/><path d="M10 4l-.5 7-3 2v1.5h11V13l-3-2-.5-7"/><path d="M12 14.5V21"/>',
  ...
  // 批量操作（列表 + 勾选）
  listCheck:
    '<path d="M8 6h13M8 12h13M8 18h13"/><path d="M3.5 6.5 5 8 7.5 5"/><path d="M3.5 12.5 5 14 7.5 11"/><path d="M3.5 18.5 5 20 7.5 17"/>',
  // 账号体系
